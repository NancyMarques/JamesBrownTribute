...
function renderData() {
    ...
    html += `<div class="buttons-container" style="background-color: black; display:flex; justify-content: center;">
        <!-- TODO -->
        <a href="index.html" style="text-decoration: none;"><h1 style="font-size: 20px; color: rgb(205, 227, 131); line-height: 2; letter-spacing: 4px; font-family: Arial, Helvetica, sans-serif;
        line-height: 2;">
          Return to main menu</h1></a>
    </div>`;
